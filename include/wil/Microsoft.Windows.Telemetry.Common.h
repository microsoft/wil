...
#ifndef __MICROSOFT_WINDOWS_TELEMETRY_COMMON_INCLUDED
#define __MICROSOFT_WINDOWS_TELEMETRY_COMMON_INCLUDED
...
#endif // __MICROSOFT_WINDOWS_TELEMETRY_COMMON_INCLUDED
