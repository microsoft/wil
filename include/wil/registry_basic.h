...
namespace reg_view_details
{
    ...
    private:
        ...
        typename get_err_policy::result get_value_internal(_In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name, R& return_value, DWORD type = ::wil::reg::reg_view_details::get_value_type<R>()) const
        {
            for (;;)
            {
                ...
                auto error = ::RegGetValueW(
                    ...
                    &data_size_bytes);
                printf("\n\tRegGetValueW returned error %d (data_size_bytes %lu, buffer pointer %p)\n", error, data_size_bytes, ::wil::reg::reg_view_details::get_buffer(return_value));
    ...
    public:
        ...
        ::wil::reg::optional_value<R> try_get_value(_In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name, DWORD type = ::wil::reg::reg_view_details::get_value_type<R>()) const
        {
            ...
            {
                printf("\n\ttry_get_value returned succeeded\n");
            ...
            {
                printf("\n\ttry_get_value returned file-not-found\n");
                return_value.value = {};
                return return_value;
            }

            printf("\n\ttry_get_value returned error %d\n", return_value.inner_error);
...
inline ::wil::reg::optional_value<DWORD> try_get_value_dword(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name) WI_NOEXCEPT
{
    const reg_view_details::reg_view regview{key};
    return regview.try_get_value<DWORD>(subkey, value_name);
}

inline ::wil::reg::optional_value<DWORD> try_get_value_dword(HKEY key, _In_opt_ PCWSTR value_name) WI_NOEXCEPT
{
...
inline ::wil::reg::optional_value<DWORD64> try_get_value_qword(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name) WI_NOEXCEPT
{
    const reg_view_details::reg_view regview{key};
    return regview.try_get_value<DWORD64>(subkey, value_name);
}

inline ::wil::reg::optional_value<DWORD64> try_get_value_qword(HKEY key, _In_opt_ PCWSTR value_name) WI_NOEXCEPT
{
...
{
    const reg_view_details::reg_view regview{key};
    ::wil::reg::optional_value<::std::wstring> optionalvalue;
