...
#pragma region HSTRING Helpers
    ...
    */
    struct TwoPhaseHStringConstructor
    {
        ...
        //! Returns the HSTRING after it has been populated like Detach() or release(); be sure to put this in a RAII type to manage its lifetime.
        HSTRING Promote()
        {
            m_characterLength = 0;
...
//! Run a function when an async operation completes. Use Microsoft::WRL::FtmBase for TAgility to make the completion handler agile and run on the async thread.
