...
struct err_returncode_policy
{
    ...
    __forceinline static HRESULT Win32Handle(HANDLE handleIn, _Out_ HANDLE* handleOut) WI_NOEXCEPT
    {
        *handleOut = handleIn;
...
struct err_failfast_policy
{
    ...
    __forceinline static result Win32Handle(HANDLE handleIn, _Out_ HANDLE* handleOut) WI_NOEXCEPT
    {
        *handleOut = handleIn;
