...
namespace wil
{
    namespace details
    {
        ...
        template<> inline constexpr auto intsafe_conversion<__int64, char> = LongLongToChar;
        template<> inline constexpr auto intsafe_conversion<__int64, int> = LongLongToInt;
        template<> inline constexpr auto intsafe_conversion<__int64, long> = LongLongToLong;
        template<> inline constexpr auto intsafe_conversion<__int64, short> = LongLongToShort;
        template<> inline constexpr auto intsafe_conversion<__int64, signed char> = LongLongToInt8;
        template<> inline constexpr auto intsafe_conversion<__int64, unsigned __int64> = LongLongToULongLong;
        template<> inline constexpr auto intsafe_conversion<__int64, unsigned char> = LongLongToUChar;
        template<> inline constexpr auto intsafe_conversion<__int64, unsigned int> = LongLongToUInt;
        template<> inline constexpr auto intsafe_conversion<__int64, unsigned long> = LongLongToULong;
        template<> inline constexpr auto intsafe_conversion<__int64, unsigned short> = LongLongToUShort;
        template<> inline constexpr auto intsafe_conversion<int, char> = IntToChar;
        template<> inline constexpr auto intsafe_conversion<int, short> = IntToShort;
        template<> inline constexpr auto intsafe_conversion<int, signed char> = IntToInt8;
        template<> inline constexpr auto intsafe_conversion<int, unsigned __int64> = IntToULongLong;
        template<> inline constexpr auto intsafe_conversion<int, unsigned char> = IntToUChar;
        template<> inline constexpr auto intsafe_conversion<int, unsigned int> = IntToUInt;
        template<> inline constexpr auto intsafe_conversion<int, unsigned long> = IntToULong;
        template<> inline constexpr auto intsafe_conversion<int, unsigned short> = IntToUShort;
        template<> inline constexpr auto intsafe_conversion<long, char> = LongToChar;
        template<> inline constexpr auto intsafe_conversion<long, int> = LongToInt;
        template<> inline constexpr auto intsafe_conversion<long, short> = LongToShort;
        template<> inline constexpr auto intsafe_conversion<long, signed char> = LongToInt8;
        template<> inline constexpr auto intsafe_conversion<long, unsigned __int64> = LongToULongLong;
        template<> inline constexpr auto intsafe_conversion<long, unsigned char> = LongToUChar;
        template<> inline constexpr auto intsafe_conversion<long, unsigned int> = LongToUInt;
        template<> inline constexpr auto intsafe_conversion<long, unsigned long> = LongToULong;
        template<> inline constexpr auto intsafe_conversion<long, unsigned short> = LongToUShort;
        template<> inline constexpr auto intsafe_conversion<short, char> = ShortToChar;
        template<> inline constexpr auto intsafe_conversion<short, signed char> = ShortToInt8;
        template<> inline constexpr auto intsafe_conversion<short, unsigned __int64> = ShortToULongLong;
        template<> inline constexpr auto intsafe_conversion<short, unsigned char> = ShortToUChar;
        template<> inline constexpr auto intsafe_conversion<short, unsigned int> = ShortToUInt;
        template<> inline constexpr auto intsafe_conversion<short, unsigned long> = ShortToULong;
        template<> inline constexpr auto intsafe_conversion<short, unsigned short> = ShortToUShort;
        template<> inline constexpr auto intsafe_conversion<signed char, unsigned __int64> = Int8ToULongLong;
        template<> inline constexpr auto intsafe_conversion<signed char, unsigned char> = Int8ToUChar;
        template<> inline constexpr auto intsafe_conversion<signed char, unsigned int> = Int8ToUInt;
        template<> inline constexpr auto intsafe_conversion<signed char, unsigned long> = Int8ToULong;
        template<> inline constexpr auto intsafe_conversion<signed char, unsigned short> = Int8ToUShort;
        template<> inline constexpr auto intsafe_conversion<unsigned __int64, __int64> = ULongLongToLongLong;
        template<> inline constexpr auto intsafe_conversion<unsigned __int64, char> = ULongLongToChar;
        template<> inline constexpr auto intsafe_conversion<unsigned __int64, int> = ULongLongToInt;
        template<> inline constexpr auto intsafe_conversion<unsigned __int64, long> = ULongLongToLong;
        template<> inline constexpr auto intsafe_conversion<unsigned __int64, short> = ULongLongToShort;
        template<> inline constexpr auto intsafe_conversion<unsigned __int64, signed char> = ULongLongToInt8;
        template<> inline constexpr auto intsafe_conversion<unsigned __int64, unsigned char> = ULongLongToUChar;
        template<> inline constexpr auto intsafe_conversion<unsigned __int64, unsigned int> = ULongLongToUInt;
        template<> inline constexpr auto intsafe_conversion<unsigned __int64, unsigned long> = ULongLongToULong;
        template<> inline constexpr auto intsafe_conversion<unsigned __int64, unsigned short> = ULongLongToUShort;
        template<> inline constexpr auto intsafe_conversion<unsigned char, char> = UInt8ToChar;
        template<> inline constexpr auto intsafe_conversion<unsigned char, signed char> = UIntToInt8;
        template<> inline constexpr auto intsafe_conversion<unsigned int, char> = UIntToChar;
        template<> inline constexpr auto intsafe_conversion<unsigned int, int> = UIntToInt;
        template<> inline constexpr auto intsafe_conversion<unsigned int, long> = UIntToLong;
        template<> inline constexpr auto intsafe_conversion<unsigned int, short> = UIntToShort;
        template<> inline constexpr auto intsafe_conversion<unsigned int, signed char> = UIntToInt8;
        template<> inline constexpr auto intsafe_conversion<unsigned int, unsigned char> = UIntToUChar;
        template<> inline constexpr auto intsafe_conversion<unsigned int, unsigned short> = UIntToUShort;
        template<> inline constexpr auto intsafe_conversion<unsigned long, char> = ULongToChar;
        template<> inline constexpr auto intsafe_conversion<unsigned long, int> = ULongToInt;
        template<> inline constexpr auto intsafe_conversion<unsigned long, long> = ULongToLong;
        template<> inline constexpr auto intsafe_conversion<unsigned long, short> = ULongToShort;
        template<> inline constexpr auto intsafe_conversion<unsigned long, signed char> = ULongToInt8;
        template<> inline constexpr auto intsafe_conversion<unsigned long, unsigned char> = ULongToUChar;
        template<> inline constexpr auto intsafe_conversion<unsigned long, unsigned int> = ULongToUInt;
        template<> inline constexpr auto intsafe_conversion<unsigned long, unsigned short> = ULongToUShort;
        template<> inline constexpr auto intsafe_conversion<unsigned short, char> = UShortToChar;
        template<> inline constexpr auto intsafe_conversion<unsigned short, short> = UShortToShort;
        template<> inline constexpr auto intsafe_conversion<unsigned short, signed char> = UShortToInt8;
        template<> inline constexpr auto intsafe_conversion<unsigned short, unsigned char> = UShortToUChar;
    }
