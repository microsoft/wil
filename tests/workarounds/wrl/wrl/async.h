    ...
    namespace Foundation
    {
        ...
        namespace Diagnostics
        {
            ...
            const ::Windows::Foundation::Diagnostics::CausalityTraceLevel CausalityTraceLevel_Verbose =
                ::Windows::Foundation::Diagnostics::CausalityTraceLevel_Verbose;
            const ::Windows::Foundation::Diagnostics::CausalityTraceLevel CausalityTraceLevel_Important =
                ::Windows::Foundation::Diagnostics::CausalityTraceLevel_Important;
            const ::Windows::Foundation::Diagnostics::CausalityTraceLevel CausalityTraceLevel_Required =
                ::Windows::Foundation::Diagnostics::CausalityTraceLevel_Required;

            const ::Windows::Foundation::Diagnostics::CausalityRelation CausalityRelation_Join =
                ::Windows::Foundation::Diagnostics::CausalityRelation_Join;
            const ::Windows::Foundation::Diagnostics::CausalityRelation CausalityRelation_Choice =
                ::Windows::Foundation::Diagnostics::CausalityRelation_Choice;
            const ::Windows::Foundation::Diagnostics::CausalityRelation CausalityRelation_Error =
                ::Windows::Foundation::Diagnostics::CausalityRelation_Error;
            const ::Windows::Foundation::Diagnostics::CausalityRelation CausalityRelation_Cancel =
                ::Windows::Foundation::Diagnostics::CausalityRelation_Cancel;
            const ::Windows::Foundation::Diagnostics::CausalityRelation CausalityRelation_AssignDelegate =
                ::Windows::Foundation::Diagnostics::CausalityRelation_AssignDelegate;

            const ::Windows::Foundation::Diagnostics::CausalitySynchronousWork CausalitySynchronousWork_CompletionNotification =
                ::Windows::Foundation::Diagnostics::CausalitySynchronousWork_CompletionNotification;
            const ::Windows::Foundation::Diagnostics::CausalitySynchronousWork CausalitySynchronousWork_ProgressNotification =
                ::Windows::Foundation::Diagnostics::CausalitySynchronousWork_ProgressNotification;
            const ::Windows::Foundation::Diagnostics::CausalitySynchronousWork CausalitySynchronousWork_Execution =
                ::Windows::Foundation::Diagnostics::CausalitySynchronousWork_Execution;
        } // namespace Diagnostics
    }     // namespace Foundation
} // namespace Windows
} // namespace ABI
...
#define WRL_DEFAULT_CAUSALITY_SOURCE ::ABI::Windows::Foundation::Diagnostics::CausalitySource::CausalitySource_Application
    ...
    template <PCWSTR OpName = nullptr, const GUID& PlatformId = WRL_DEFAULT_CAUSALITY_GUID, ::ABI::Windows::Foundation::Diagnostics::CausalitySource CausalitySource = WRL_DEFAULT_CAUSALITY_SOURCE>
...
#pragma region AsyncOptionsHelper
        ...
        {
            static const Microsoft::WRL::ErrorPropagationPolicy PropagationPolicy =
                Microsoft::WRL::ErrorPropagationOptions<>::PropagationPolicy;
        };
...
#ifdef BUILD_WINDOWS
            static_assert(
                !(__is_base_of(::ABI::Windows::Foundation::IAsyncActionCompletedHandler, TComplete) && !TOptions::hasCausalityOperationName),
                "Please add name to Asynchronous Operations for Better Diagnostics: http://winri/BreakingChanges/BreakingChangeForm/Index/1992");
#endif
            static PCWSTR GetAsyncOperationName()
            {
...
#pragma endregion
    ...
    template <typename TComplete, typename TProgress = Details::Nil, AsyncResultType resultType = SingleResult, typename TAsyncBaseOptions = AsyncOptions<>>
    ...
    public:
        ...
        AsyncBase() : progressDelegate_(nullptr), progressDelegateBucketAssist_(nullptr)
        {
        }
        ...
        HRESULT FireProgress(const typename ProgressTraits::Arg2Type arg)
        {
            ...
            hr = ErrorPropagationPolicyTraits<AllOptions::PropagationPolicy>::FireProgressErrorPropagationPolicyFilter(
                hr, progressDelegate_.Get(), progressDelegateBucketAssist_);
    ...
    class AsyncBase<TComplete, Details::Nil, resultType, TAsyncBaseOptions>
        : public ::Microsoft::WRL::Implements<::ABI::Windows::Foundation::IAsyncInfo>
    {
...
#ifndef _WRL_DISABLE_CAUSALITY_
                if (SUCCEEDED(hr) && ::InitOnceExecuteOnce(&gCausalityInitOnce, InitCausality, NULL, NULL))
                {
                    TraceOperationStart();
                }
#endif // _WRL_DISABLE_CAUSALITY_
        ...
        virtual HRESULT FireCompletion()
        {
            ...
            if (completeDelegate_ != nullptr && InterlockedIncrement(&cCallbackMade_) == 1)
            {
                ...
                if (SUCCEEDED(asyncInfo.As(&operationInterface)))
                {
                    ...
                    hr = ErrorPropagationPolicyTraits<AllOptions::PropagationPolicy>::FireCompletionErrorPropagationPolicyFilter(
                        hr, completeDelegate_.Get(), completeDelegateBucketAssist_);
                    completeDelegate_ = nullptr;
    ...
    protected:
        ...
        bool TryTransitionToError(
            const HRESULT error,
            CancelTransitionPolicy cancelBehavior = CancelTransitionPolicy::RemainCanceled,
            _In_opt_ void* bucketAssist = nullptr)
        {
...
#pragma warning(pop)
            ...
            else if (current != Details::_Started && current != Details::_Canceled && current != Details::_Completed)
            {
#if (NTDDI_VERSION >= NTDDI_WINBLUE)
                ::RoOriginateError(E_ILLEGAL_METHOD_CALL, nullptr);
#endif // (NTDDI_VERSION >= NTDDI_WINBLUE)
    ...
    private:
        ...
        static BOOL WINAPI InitCausality(_Inout_opt_ PINIT_ONCE InitOnce, _Inout_opt_ PVOID Parameter, _Out_opt_ PVOID* Context)
        {
            ...
            {
#endif
                Microsoft::WRL::Wrappers::HStringReference hstrCausalityTraceName(
        ...
        inline bool TransitionToState(const Details::AsyncStatusInternal newState)
        {
            ...
            Details::AsyncStatusInternal retState = static_cast<Details::AsyncStatusInternal>(::_InterlockedCompareExchange(
                reinterpret_cast<volatile LONG*>(&currentStatus_), newState, static_cast<LONG>(current)));
    ...
    protected:
        ...
        inline bool TransitionCanceledToCompleted()
        {
            ...
            // this method)
            Details::AsyncStatusInternal retState = static_cast<Details::AsyncStatusInternal>(::_InterlockedCompareExchange(
                reinterpret_cast<volatile LONG*>(&currentStatus_),
        ...
        {
            return (status == Details::_Error || status == Details::_Canceled || status == Details::_Completed || status == Details::_Closed);
        }
...
#pragma region TracingMethods
        ...
        void TraceExecutionComplete(::ABI::Windows::Foundation::Diagnostics::CausalityTraceLevel traceLevel)
        {
            ...
            if (gCausality && AllOptions::CausalityEnabled)
            {
                ...
                // normal flow of AsyncOperations
                gCausality->TraceSynchronousWorkCompletion(
                    traceLevel, AllOptions::GetCausalitySource(), ::ABI::Windows::Foundation::Diagnostics::CausalitySynchronousWork_Execution);
            }
#endif // _WRL_DISABLE_CAUSALITY_
        }
...
#define CAUSALITY_OPTIONS(OpName) Microsoft::WRL::AsyncCausalityOptions<OpName>
